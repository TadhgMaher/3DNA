          ...
          <div>
            <div className="flex items-center space-x-3 mb-4">
              <div className="w-12 h-12 bg-blue-900 rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-lg">3DNA</span>
              </div>
              <span className="text-2xl font-bold">3DNA</span>
            </div>
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    key={social.label}
                    href={social.href}
                    className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center hover:bg-blue-900 transition-colors duration-300"
